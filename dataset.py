...
# 4/24/2024
# Purpose - This file is for preprocess in the dataset
...
class MyImageFolder(Dataset):
    ...
    def __getitem__(self, index):
        ...
        low_res = config.low_res_transform(image=both_transform)["image"]
        high_res = config.high_res_transform(image=both_transform)["image"]
